...
function atualizarCampos() {
    ...
    document.getElementById('ctps-display').innerText = document.getElementById('ctps').value;
    

    // Formata a data de admissão para dd/mm/aaaa
    ...
    document.getElementById('admissao-display').innerText = dataFormatada;

    // Corrija aqui: busque o select antes de usar
...
// Gere a tabela ao carregar a página se já houver competência selecionada
document.addEventListener('DOMContentLoaded', () => {
